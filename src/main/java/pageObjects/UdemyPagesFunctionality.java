...
//	 TO SEARCH THE ELEMENT WHERE FILTER/LEVEL=INTERMEDIATE (NEGATIVE TEST1)
...
//		TO SEARCH THE ELEMENT WHERE FILTER/LANGUAGE=BAHASA
		public void selectFiltersForLangageBahasa() {
			List<WebElement> dropdown = driver.findElements(filterContainer);
			for (int i = 0; i < dropdown.size(); i++) 
			{
